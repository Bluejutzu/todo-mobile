    ...
    return (
        <View>
            ...
            <Card style={styles.section}>
                ...
                <Text style={[styles.description, { color: themeColors.textSecondary }]}>
                    Choose which AI model to use. Free models work without an API key, while paid models require your own OpenRouter API key.
                </Text>
                ...
                {getRecommendedModels().map(model => (
                    <TouchableOpacity
                        ...
                        style={[
                            styles.modelOption,
                            {
                                backgroundColor: preferences?.ai?.model === model.id
                                    ? themeColors.primary + '20'
                                    : themeColors.surface,
                                borderColor: preferences?.ai?.model === model.id
                                    ? themeColors.primary
                                    : themeColors.border,
                            },
                        ]}
                    ...
                    >
                        <View style={styles.modelHeader}>
                            ...
                            <View style={[
                                styles.modelBadge,
                                model.free ? styles.badgeFree : styles.badgePaid
                            ]}>
                ...
                {showAllModels && (
                    <>
                        ...
                        {getFreeModels().filter(m => !m.recommended).map(model => (
                            <TouchableOpacity
                                key={model.id}
                                style={[
                                    styles.modelOption,
                        ...
                        {getPaidModels().filter(m => !m.recommended).map(model => (
                            <TouchableOpacity
                                key={model.id}
                                style={[
                                    styles.modelOption,
