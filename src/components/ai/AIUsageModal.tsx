                ...
                <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
                    ...
                    <View style={[styles.section, { backgroundColor: themeColors.surface }]}>
                        ...
                        <View style={[styles.infoBox, { backgroundColor: themeColors.background }]}>
                            ...
                            <Text style={[styles.infoText, { color: themeColors.textSecondary }]}>
                                Average: {aiConfig?.requestCount ? Math.round((aiConfig.totalTokensUsed || 0) / aiConfig.requestCount) : 0} tokens per request
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={[styles.section, { backgroundColor: themeColors.surface }]}>
                        <View style={styles.sectionHeader}>
                            ...
                            <Text style={[styles.sectionTitle, { color: themeColors.text }]}>Active Features</Text>
                        </View>
                        <View style={styles.featuresList}>
                            {aiConfig?.todoImprovement && (
                                <View style={styles.featureItem}>
                                    <Ionicons name="sparkles" size={16} color={themeColors.primary} />
                                    <Text style={[styles.featureText, { color: themeColors.text }]}>Todo Improvement</Text>
                                </View>
                            )}
                            {aiConfig?.autoCategory && (
                                <View style={styles.featureItem}>
                                    <Ionicons name="pricetag" size={16} color={themeColors.primary} />
                                    <Text style={[styles.featureText, { color: themeColors.text }]}>Auto Category</Text>
                                </View>
                            )}
                            {aiConfig?.prioritySuggestion && (
                                <View style={styles.featureItem}>
                                    <Ionicons name="flag" size={16} color={themeColors.primary} />
                                    <Text style={[styles.featureText, { color: themeColors.text }]}>Priority Suggestion</Text>
                                </View>
                            )}
                            {aiConfig?.subtaskGeneration && (
                                <View style={styles.featureItem}>
                                    <Ionicons name="list" size={16} color={themeColors.primary} />
                                    <Text style={[styles.featureText, { color: themeColors.text }]}>Subtask Generation</Text>
                                </View>
                            )}
                        </View>
                    </View>
