...
export function Button({
  ...
  const textStyle = { color: textColor, fontSize: config.fontSize };

  return (
    <TouchableOpacity
      style={[buttonStyle, styles.base, (disabled || loading) && styles.disabled, style]}
      onPress={onPress}
    ...
    >
      {loading ? (
        ...
        <View style={styles.content}>
          {icon && (
            <Ionicons name={icon} size={config.iconSize} color={textColor} style={styles.icon} />
          )}
